...
abstract final class MockData {
  ...
  static const destinations = <Destination>[
    Destination(
      ...
      description: 'Sunny coastal city with beaches, seafood, islands, and relaxed outdoor activities.',
      category: 'Beaches',
      distanceKm: 22,
      rating: 4.8,
      reviewCount: 1200,
    ...
    Destination(
      ...
      description: 'Cool mountain city with pine forests, lakes, cafes, and slow scenic routes.',
      category: 'Mountains',
      distanceKm: 145,
      rating: 4.9,
      reviewCount: 2100,
    ...
    Destination(
      ...
      description: 'Island destination for beach stays, sunset views, snorkeling, and seafood.',
      category: 'Beaches',
      distanceKm: 280,
      rating: 4.7,
      reviewCount: 980,
    ...
    Destination(
      ...
      description: 'Large waterfall area with fresh air, mountain views, and nature photography spots.',
      category: 'Waterfalls',
      distanceKm: 1200,
      rating: 4.6,
      reviewCount: 450,
    ...
    Destination(
      ...
      name: 'Mũi Né',
      tagline: 'Desert & Sea',
      description: 'Coastal escape known for dunes, wind, beaches, and seafood restaurants.',
      category: 'Beaches',
      distanceKm: 180,
      rating: 4.5,
      reviewCount: 760,
    ...
    Destination(
      ...
      description: 'Highland destination with terraced fields, cool weather, trekking, and local culture.',
      category: 'Mountains',
      distanceKm: 1350,
      rating: 4.8,
      reviewCount: 890,
